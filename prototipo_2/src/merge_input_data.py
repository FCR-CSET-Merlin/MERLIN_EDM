...
def split_and_scale_data(df, train_end_year=2021, val_end_year=2022): 
...
if __name__ == "__main__":
    ...
    if all(os.path.exists(f) for f in [TEMP_DEMAND_FILE, CALENDAR_FILE, SHARES_FILE, DEMAND_FILE]):
        ...
        train, val, test, temp_scaler, target_scaler = split_and_scale_data(master_df, train_end_year=2021, val_end_year=2022)
