...
if __name__ == "__main__":
    ...
    print("Cargando datos de todas las regiones y comunas")
    ...
    # 1. Definir rutas
    TRAIN_FILE = f"../data/processed/ds_comunal/train_ciego_global.parquet"
    VAL_FILE   = f"../data/processed/ds_comunal/val_ciego_global.parquet"
    MODEL_DIR  = "../models/ds_comunal/"
    NAME = f"best_merlin_mlp_global.keras"
