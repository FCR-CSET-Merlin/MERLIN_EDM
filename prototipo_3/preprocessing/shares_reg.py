...
def merge_shares_to_hourly(hourly_filepath, df_shares, output_filepath, alias_filepath):
    ...
    print(f"\n2. Cargando matriz horaria REGIONAL desde: {hourly_filepath}")
...
if __name__ == "__main__":
    ...
    HOURLY_FILE = "../data/interim/calendario_regional.parquet" 
    ALIAS_FILE = "../data/raw/reg_alias.json"  # <--- NUEVA RUTA
    FINAL_OUTPUT = "../data/interim/sector_shares_regional.parquet" 
    ...
    if os.path.exists(SECTORIAL_FILE) and os.path.exists(HOURLY_FILE):
        ...
        cols_to_show = ['fecha_hora', 'region', 'region_share', 'share_I', 'share_R', 'share_C', 'share_P', 'share_T']
